...
![alt text](assets/images/starwarsGame.png "Screen capture Image")
 ...
 1.  * When the game starts, the player will choose a character by clicking on the fighter's picture. The player will fight as that character for the rest of the game.
   ...
   * The player must then defeat all of the remaining fighters. Enemies are highlighted red and moved to the `Enemies Available to Attack` Section.

   * The player chooses an opponent by clicking on an enemy's picture.

   * Once the player selects an opponent, that enemy is moved to a `defender area`.

2. * The player will now be able to click the `attack` button.
